    ...
    <section class="section section01">
        <div class="container">
            <div class="row">
                ...
                <button class="button-square centering mt-5">詳しくはこちら<i class="fas fa-angle-double-right pl-3"></i></button>
            </div><!-- row end -->
        </div><!-- container end -->
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 mt-5">
                    <button class="button-square centering">詳しくはこちら<i class="fas fa-angle-double-right pl-3"></i></button>
                </div>
        ...
        <div class="container">
            <div class="row">
               ...
               <div class="col-12 text-center mb-5">
                   <img src="<?php echo esc_url(get_theme_file_uri('images/large-room.jpg')); ?>" alt="２階大部屋　８人～２０人">
